...
export const ResultsSummary: React.FC<ResultsSummaryProps> = ({
  ...
  return (
    <div className="bg-white px-5 pt-2 pb-1 rounded-xl border border-gray-200 flex flex-col gap-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5 items-stretch">
        ...
        <div className="xl:col-span-8 flex flex-col sm:flex-row items-center gap-0">
          ...
          <div className="flex-1 w-full bg-white p-4 rounded-lg border border-blue-200 hover:border-blue-400 transition duration-300 shadow-sm">
            ...
            <div className="flex flex-col gap-1.5 font-mono text-sm text-gray-900">
        ...
        <div className="xl:col-span-4 flex flex-col gap-2 justify-center">
          ...
          {/* Compression Ratio */}
          <div className={`py-${BARS_PY} bg-slate-50 px-3.5  rounded-lg border border-gray-200 flex flex-col gap-1.5 shadow-sm`}>
            <div className="flex justify-between items-center">
